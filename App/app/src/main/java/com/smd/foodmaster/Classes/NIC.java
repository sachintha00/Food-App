package com.smd.foodmaster.Classes;
...
public class NIC {
    ...
    private void oldNic(String nicNumber) {
        firstTwo = nicNumber.substring(0,2);
    ...
    protected void finalInit(){
        ...
        if (checkValue == 10)
        {
            AGE = Integer.toString(Calendar.getInstance().get(Calendar.YEAR) - Integer.parseInt(("19" + firstTwo)));
        }
        else if (checkValue == 12)
        {
            AGE =  Integer.toString(Calendar.getInstance().get(Calendar.YEAR) - Integer.parseInt(firstTwo));
        }
        else
        {
            AGE = null;
